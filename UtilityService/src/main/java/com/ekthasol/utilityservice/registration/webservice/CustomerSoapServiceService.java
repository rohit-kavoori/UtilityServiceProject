 ...
 * 2016-08-16T11:12:19.490-05:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "CustomerSoapServiceService", 
                  wsdlLocation = "file:/C:/BCJ_MAY16/Develop/CoreJAVA/ADV_WorkSpace/UtilityService/src/main/resources/test.wsdl",
...
public class CustomerSoapServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/BCJ_MAY16/Develop/CoreJAVA/ADV_WorkSpace/UtilityService/src/main/resources/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerSoapServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/BCJ_MAY16/Develop/CoreJAVA/ADV_WorkSpace/UtilityService/src/main/resources/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
