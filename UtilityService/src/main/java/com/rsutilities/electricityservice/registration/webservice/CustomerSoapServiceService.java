 ...
 * 2016-08-17T00:14:05.894-05:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "CustomerSoapServiceService", 
                  wsdlLocation = "file:/C:/BCJ_MAY16/Develop/Repository/UtilityServiceProject/UtilityService/src/main/resources/test.wsdl",
                  targetNamespace = "http://service.customerservice.rsutilities.com/") 
public class CustomerSoapServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.customerservice.rsutilities.com/", "CustomerSoapServiceService");
    public final static QName CustomerSoapServicePort = new QName("http://service.customerservice.rsutilities.com/", "CustomerSoapServicePort");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/BCJ_MAY16/Develop/Repository/UtilityServiceProject/UtilityService/src/main/resources/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerSoapServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/BCJ_MAY16/Develop/Repository/UtilityServiceProject/UtilityService/src/main/resources/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
